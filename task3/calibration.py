# -*- coding: utf-8 -*-
"""AprilTag id=0 camera-to-base calibration.

This file intentionally contains the small transform and tag-detection helpers
used by calibration, so the task3_new workflow stays compact.
"""
