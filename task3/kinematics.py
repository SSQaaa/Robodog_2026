# -*- coding: utf-8 -*-
"""Planar IK for the rebuilt task3 arm.

Joint convention:
- theta1: link1 relative to vertical ground direction. Clockwise is positive.
- theta2: link2 relative to link1. Clockwise is positive.
- theta3: link3 relative to link2. Clockwise is positive.
- Link3/gripper horizontal means theta1 + theta2 + theta3 = 90 deg.
"""
...
def solve_arm_target(x_mm, y_mm, z_mm, arm_cfg):
    ...
    for q2_standard in (math.acos(cos_q2), -math.acos(cos_q2)):
        ...
        # Convert from standard angle-from-horizontal to our angle-from-vertical, clockwise-positive convention.
        ...
        posture_penalty = abs(theta1) + 0.3 * abs(theta2) + 0.1 * abs(theta3 - 90.0)
