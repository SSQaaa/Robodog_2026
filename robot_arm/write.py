...
while True:
    ...
    if index == 0:
        ...
        if mode == chr(0x1b):       # ESC
            ...
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_1, 1899, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_2, 2044, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_3, 1985, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_4, 1759, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_5, 1269, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_6, 2026, SCS_MOVING_SPEED, SCS_MOVING_ACC)  
        elif mode == chr(0x32):      # 初始姿态2    键盘上的 2，不是数字小键盘上的2
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_1, 2200, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_2, 2044, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_3, 1985, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_4, 1759, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_5, 1269, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            ...
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_1, 2200, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_2, 2086, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_3, 2012, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            time.sleep(2)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_4, 1072, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_5, 2662, SCS_MOVING_SPEED, SCS_MOVING_ACC)
            scs_comm_result, scs_error = packetHandler.WritePosEx(SCS_ID_6, 2003, SCS_MOVING_SPEED, SCS_MOVING_ACC)
